...
Date: 10/17/2019
Project: The hard project herein is a Test Driven Development for the game Rock Scissors Paper Spock Lizard.
 in my opinion, its fine and ugly and very emotionally damaging
 thanks */

/**
 *author Joseph Okonofua
 */
public class RPSLSpock {
     ...
     * @author Joseph Okonofua
     * @param pick
     * @return returns returns a loop option for the pick variable
     */
    ...
    /**
     * @author Joseph Okonofua
     * @return initializes the bounds of the pick variable
     */
     ...
     * @param c_pick
     * @param h_pick
     * @return checks if the computer's choice beats the human choice. if Computer wins, the below code is executed. If not human wins
     */
